...
Rebuilding the image one last time reveals the size of the Docker image has increased slightly to **187.4MB**. A major improvement from the original **2.19GB** image!
